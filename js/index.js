...
//is for where you want teh board
...
function Node(cell) {
    ...
    this.take_one = function (direction) {
      ...
      // null cell for nonexistant part of board (nonexistent, as in doesn't exist yet)
        if (look == null) {
    ...
    /*** the folloiwng methods operate on the nodes ***/
    ...
    this.kids = function () {
        ...
        // this check isn't necessary but lol
...
$(document).on('click', '.js-instructions', function () {    
    html = "<div class='instructions-box'><div class='instructions'> " +
        "<h2>INSTRUCTIONS</h2>" +
        "Trains spawn from the bright green circle. " +
        "Your goal is to match station and train numbers, " +
        "guide the trains to the right stations by changing the tracks along their way. " +
        "Clicking the blue circles at the intersections changes tracks. " +
        "...It gets harder and there are different levels!" +
        "</div></div>";
...
function Game(difficulty) {
    ...
    switch(difficulty) {
        ...
        case 9:
            ...
            speed = [2]; // make it faster if you a tryhard xD
            interval = [3, 3, 2, 1.5];
            break;
    }
    ...
    this.draw = function() {
        ...
        for (var i = 0; i < leaves.length; i++) {
            ...
            // this is for direction of house.
    ...
    this.decorate = function(num) {
        ...
        for (var i = 0; i < num; i++) {
            ...
            //collision & overlap stuff, very triggering
    ...
    // generates sequence of trains to play, eacg with a destination & speed
...
$(document).on('click', '.js-tutorial', function () {
    ...
    setTimeout(function () {
        ...
        $('.root').parent().append('<div class="tutorial_message">Click on the blue circles to switch the direction of the train tracks.</div>');
    }, 19000);
    ...
    setTimeout(function () {
        ...
        $('.tutorial_message').html('good luck! Things get harder as they go on. Challenge accepted?').css('width', '11em');
    }, 26000);
